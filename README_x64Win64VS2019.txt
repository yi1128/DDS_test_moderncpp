...
data type USERIF_RESPONSE_DRILL_INFO from HUSS-PH.idl.
This example builds two applications, named HUSS-PH_publisher and
HUSS-PH_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing HUSS-PH-x64Win64VS2019.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          HUSS-PH-x64Win64VS2019.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   HUSS-PH_publisher or HUSS-PH_subscriber and
...
To modify the data being sent: edit the HUSS-PH_publisher.cxx
file where it says 
...
1. Right-click HUSS-PH_publisher and choose Debug > Start new instance.
2. Right-click HUSS-PH_subscriber and choose Debug > Start new instance.
...
2. Run C:\Program Files\rti_connext_dds-7.0.0\bin\..\resource\scripts\rtisetenv_x64Win64VS2019.bat
...
> objs\x64Win64VS2019\HUSS-PH_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2019\HUSS-PH_subscriber.exe -d <domain_id> -s <sample_count>
